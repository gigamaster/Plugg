<?php
class Plugg_System_Controller_Main_MinifyCss extends Sabai_Application_Controller
{
    ...
    public function getContent()
    {
        ...
        foreach (array_keys($plugins) as $plugin_name) {
            ...
            if ($plugin->hasMainCSS) {
                $content[] = file_get_contents($plugin->path . '/css/main.css');
            }
        }
