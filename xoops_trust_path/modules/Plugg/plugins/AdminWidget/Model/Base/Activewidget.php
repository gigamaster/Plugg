...
plugins/AdminWidget/Model/Activewidget.php
*/
abstract class Plugg_AdminWidget_Model_Base_Activewidget extends Sabai_Model_Entity
{
    public function __construct(Sabai_Model $model)
    {
        parent::__construct('Activewidget', $model);
        $this->_vars = array('activewidget_id' => 0, 'activewidget_created' => 0, 'activewidget_updated' => 0, 'activewidget_title' => null, 'activewidget_order' => 0, 'activewidget_position' => 0, 'activewidget_settings' => null, 'activewidget_cache' => null, 'activewidget_cache_time' => 0, 'activewidget_cache_lifetime' => 86400, 'activewidget_widget_id' => 0);
    }
    ...
    public function assignWidget(Plugg_AdminWidget_Model_Widget $entity)
    {
...
abstract class Plugg_AdminWidget_Model_Base_ActivewidgetRepository extends Sabai_Model_EntityRepository
{
    public function __construct(Sabai_Model $model)
    {
        parent::__construct('Activewidget', $model);
    ...
    {
        return new Plugg_AdminWidget_Model_Base_ActivewidgetsByRowset($rs, $this->_model->create('Activewidget'), $this->_model);
    }

    public function createCollection(array $entities = array())
    {
        return new Plugg_AdminWidget_Model_Base_Activewidgets($this->_model, $entities);
    }
}

class Plugg_AdminWidget_Model_Base_ActivewidgetsByRowset extends Sabai_Model_EntityCollection_Rowset
{
    public function __construct(Sabai_DB_Rowset $rs, Plugg_AdminWidget_Model_Activewidget $emptyEntity, Sabai_Model $model)
    {
...
class Plugg_AdminWidget_Model_Base_Activewidgets extends Sabai_Model_EntityCollection_Array
{
