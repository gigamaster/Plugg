...
plugins/AdminWidget/Model/Widget.php
*/
abstract class Plugg_AdminWidget_Model_Base_Widget extends Sabai_Model_Entity
{
    ...
    public function addActivewidget(Plugg_AdminWidget_Model_Activewidget $entity)
    {
        $this->_addEntity($entity);
        return $this;
    }

    public function removeActivewidget(Plugg_AdminWidget_Model_Activewidget $entity)
    {
...
abstract class Plugg_AdminWidget_Model_Base_WidgetRepository extends Sabai_Model_EntityRepository
{
    public function __construct(Sabai_Model $model)
    {
        parent::__construct('Widget', $model);
    ...
    {
        return new Plugg_AdminWidget_Model_Base_WidgetsByRowset($rs, $this->_model->create('Widget'), $this->_model);
    }

    public function createCollection(array $entities = array())
    {
        return new Plugg_AdminWidget_Model_Base_Widgets($this->_model, $entities);
    }
}

class Plugg_AdminWidget_Model_Base_WidgetsByRowset extends Sabai_Model_EntityCollection_Rowset
{
    public function __construct(Sabai_DB_Rowset $rs, Plugg_AdminWidget_Model_Widget $emptyEntity, Sabai_Model $model)
    {
...
class Plugg_AdminWidget_Model_Base_Widgets extends Sabai_Model_EntityCollection_Array
{
