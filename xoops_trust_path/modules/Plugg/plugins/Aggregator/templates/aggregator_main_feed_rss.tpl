...
<rdf:RDF
 ...
 <channel rdf:about="<?php echo $this->Url(array('path' => $feed->id . '/rss'));?>">
  <title><?php _h($feed->title);?> - <?php _h($this->PluginName());?> | <?php _h($this->SiteName());?></title>
  <link><?php echo $this->Url(array('path' => $feed->id));?></link>
  <description><?php _h($feed->description);?></description>
  <items>
