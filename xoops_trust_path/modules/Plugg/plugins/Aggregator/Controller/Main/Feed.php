<?php
class Plugg_Aggregator_Controller_Main_Feed extends Sabai_Application_Controller
{
    protected function _doExecute(Sabai_Request $request, Sabai_Application_Response $response)
    {
        ...
        $pages = $this->getPluginModel()->Item
            ->criteria()
            ->hidden_is(0)
            ->paginateByFeed($this->feed->id, 20, $sortby[0], $sortby[1]);
        ...
        $response->setContent($this->RenderTemplate('aggregator_main_feed', $vars));
    }
}