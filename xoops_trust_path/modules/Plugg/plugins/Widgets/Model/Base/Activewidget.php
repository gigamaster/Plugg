...
plugins/Widgets/Model/Activewidget.php
*/
abstract class Plugg_Widgets_Model_Base_Activewidget extends Sabai_Model_Entity
{
    ...
    public function assignWidget(Plugg_Widgets_Model_Widget $entity)
    {
...
abstract class Plugg_Widgets_Model_Base_ActivewidgetRepository extends Sabai_Model_EntityRepository
{
    public function __construct(Sabai_Model $model)
    {
        parent::__construct('Activewidget', $model);
    ...
    {
        return new Plugg_Widgets_Model_Base_ActivewidgetsByRowset($rs, $this->_model->create('Activewidget'), $this->_model);
    }

    public function createCollection(array $entities = array())
    {
        return new Plugg_Widgets_Model_Base_Activewidgets($this->_model, $entities);
    }
}

class Plugg_Widgets_Model_Base_ActivewidgetsByRowset extends Sabai_Model_EntityCollection_Rowset
{
    public function __construct(Sabai_DB_Rowset $rs, Plugg_Widgets_Model_Activewidget $emptyEntity, Sabai_Model $model)
    {
...
class Plugg_Widgets_Model_Base_Activewidgets extends Sabai_Model_EntityCollection_Array
{
