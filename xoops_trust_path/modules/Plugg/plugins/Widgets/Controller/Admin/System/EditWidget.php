<?php
class Plugg_Widgets_Controller_Admin_System_EditWidget extends Plugg_Form_Controller
{
    protected function _doGetFormSettings(Sabai_Request $request, Sabai_Application_Response $response, array &$formStorage)
    {
        ...
        $form = array(
            '#id' => sprintf('%s_%s_%s', 'widgets_admin_editwidget', $this->widget->plugin, $this->widget->name),
            '#action' => $this->getUrl('/system/widgets/' . $this->widget->id . '/edit'),
            '#token' => array('reuse' => true),
            'title' => array(
                '#title' => $this->_('Custom title'),
                '#default_value' => $widget_plugin->widgetsGetWidgetTitle($this->widget->name)
            ),
        );
        ...
        $form['settings'] = array_merge(
            $widget_plugin->widgetsGetWidgetSettings($this->widget->name, $current_settings),
            array(
                '#type' => 'fieldset',
                '#tree' => true,
            )
