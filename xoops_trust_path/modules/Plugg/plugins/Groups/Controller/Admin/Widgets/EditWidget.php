<?php
class Plugg_Groups_Controller_Admin_Widgets_EditWidget extends Plugg_Form_Controller
{
    protected function _doGetFormSettings(Sabai_Request $request, Sabai_Application_Response $response, array &$formStorage)
    {
        ...
        $form = array(
            '#id' => sprintf('%s_%s_%s', 'groups_admin_editwidget', $this->widget->plugin, $this->widget->name),
