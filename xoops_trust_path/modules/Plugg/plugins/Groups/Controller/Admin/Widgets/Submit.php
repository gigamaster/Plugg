<?php
class Plugg_Groups_Controller_Admin_Widgets_Submit extends Sabai_Application_Controller
{
    function _doExecute(Sabai_Request $request, Sabai_Application_Response $response)
    {
        ...
        if (!Sabai_Token::validate($token_value, 'groups_admin_widgets_submit', false)) {
            $response->setError($this->_('Invalid request'), $url);
            return;
        }
