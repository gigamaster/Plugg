...
<?php $this->_e('Choose the fields you want to add to the form by dragging them from the fields list on the right to the area on the left and position them in the order you would like them to appear.');?>
</div>
