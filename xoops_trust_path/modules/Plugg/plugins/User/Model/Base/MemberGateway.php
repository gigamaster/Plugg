...
abstract class Plugg_User_Model_Base_MemberGateway extends Sabai_Model_Gateway
{
    ...
    {
        return array('member_id' => Sabai_Model::KEY_TYPE_INT, 'member_created' => Sabai_Model::KEY_TYPE_INT, 'member_updated' => Sabai_Model::KEY_TYPE_INT, 'member_role_id' => Sabai_Model::KEY_TYPE_INT, 'member_user_id' => Sabai_Model::KEY_TYPE_INT);
    }
    ...
    protected function _getInsertQuery($values)
    {
        ...
        return sprintf("INSERT INTO %smember(member_created, member_updated, member_role_id, member_user_id) VALUES(%d, %d, %d, %d)", $this->_db->getResourcePrefix(), $values['member_created'], $values['member_updated'], $values['member_role_id'], $values['member_user_id']);
    }
    ...
    protected function _getUpdateQuery($id, $values)
    {
        ...
        return sprintf("UPDATE %smember SET member_updated = %d, member_role_id = %d, member_user_id = %d WHERE member_id = %d AND member_updated = %d", $this->_db->getResourcePrefix(), $values['member_updated'], $values['member_role_id'], $values['member_user_id'], $id, $last_update);
    }
