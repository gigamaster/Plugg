...
abstract class Plugg_User_Model_Base_Widget extends Sabai_Model_Entity
{
    ...
    public function addActivewidget(Plugg_User_Model_Activewidget $entity)
    {
        $this->_addEntity($entity);
        return $this;
    }

    public function removeActivewidget(Plugg_User_Model_Activewidget $entity)
    {
...
{
    public function __construct(Sabai_DB_Rowset $rs, Plugg_User_Model_Widget $emptyEntity, Sabai_Model $model)
    {
